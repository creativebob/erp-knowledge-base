...
**Статус:** план к реализации с учётом текущего кода. Референс по старой системе: `erp.local/docs/old-system-for-references` (если есть) — наблюдения, не копия схемы.
